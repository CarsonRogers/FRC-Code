...
public class Constants {
    ...
    public static class ModuleConstants{
        ...
        public static final class ModFR{
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(59.3);
        }
        ...
        public static final class ModBL{
            ...
            public static final int encoderID = 3;
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(71.0);
        }
    ...
    public static class VisionConstants{
        ...
        public static final Transform3d frontRobotToCam = 
            new Transform3d(
                Units.inchesToMeters(-4), // Front to Back Translation in meters, negative is backwards
                Units.inchesToMeters(-0.5), // Left to Right Translation in meters, negative is right I think
                Units.inchesToMeters(25), // Hight Translation in meters, negative is downwards
                new Rotation3d(
                    Units.degreesToRadians(0), // Roll in radians 
                    Units.degreesToRadians(0), // Pitch in radians
                    Units.degreesToRadians(0)  // Yaw in radians, left is negative
                ));

        public static final String backCamName = "backCamera";
        public static final Transform3d backRobotToCam = 
            new Transform3d(
                Units.inchesToMeters(-4), // Front to Back Translation in meters, negative is backwards
                Units.inchesToMeters(0), // Left to Right Translation in meters, negative is right I think
                Units.inchesToMeters(20), // Hight Translation in meters, negative is downwards
                new Rotation3d(
                    Units.degreesToRadians(0), // Roll in radians 
                    Units.degreesToRadians(0), // Pitch in radians
                    Units.degreesToRadians(0)  // Yaw in radians, left is negative
