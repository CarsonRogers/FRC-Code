...
public class Swerve extends SubsystemBase {
  ...
  public Swerve() {
    ...
    /**
     * Creates a new instance of Swerve Drive Pose Estimator
     * This is responsible for keeping track of the robot pose and adding vision measurements
     * 
     * Initialization includes:
     *  - the swerveKinetatics object which is the kinematic property of the swerve dirve
     *  - The method getHeading() which returns an array of all the module positions
     *  - getModulePositions() which returns an array of all the module positions
     *  - A Pose2d from the newly initialized swerveOdometry
     */
    poseEstimator = 
   ...
   * The swerve pose estimator is updated
    ...
    if (isLocked){
      final SwerveModuleState[] swerveModuleStates =
          new SwerveModuleState[] {
            new SwerveModuleState(0.2, Rotation2d.fromDegrees(45+180)),
      ...
      final Translation2d centerOfRotation = new Translation2d();
